...
public class UserAddressPageUI {
	...
	public static final String ADD_NEW_BUTTON = "xpath=//button[@type='button' and text()='Add new']";
	...
	public static final String ZIP_CODE_TEXTBOX = "xpath=//input[@id='Address_ZipPostalCode']";
	...
	public static final String ADDRESS_TITLE = "xpath=//div[@class='address-list']//div[@class='title']";
}
